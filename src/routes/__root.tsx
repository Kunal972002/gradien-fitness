...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "GRADIEN — Premium Fitness for Female Executives" },
      ...
      { name: "author", content: "GRADIEN Fitness" },
      ...
      { property: "og:site_name", content: "GRADIEN Fitness" },
      { property: "og:locale", content: "en_US" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@GradienFitness" },
      { name: "twitter:title", content: "GRADIEN — Premium Fitness for Female Executives" },
...
function RootShell({ children }: { children: React.ReactNode }) {
  const organizationSchema = {
    ...
    "url": "https://gradien.fitness",
    "logo": "https://gradien.fitness/favicon.svg",
    "contactPoint": {
      "@type": "ContactPoint",
      "telephone": "+1-555-123-4567",
      "contactType": "customer service",
      "email": "hello@gradien.fitness",
    },
    "sameAs": [
      "https://instagram.com/gradienfitness",
      "https://youtube.com/@gradienfitness",
      "https://twitter.com/GradienFitness",
    ],
  };
  ...
  const websiteSchema = {
    ...
    "potentialAction": {
      "@type": "SearchAction",
      "target": "https://gradien.fitness/blogs?q={search_term_string}",
